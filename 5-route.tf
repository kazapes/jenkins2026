...
resource "aws_route_table_association" "private-af-south-1c" {
  subnet_id      = aws_subnet.private-af-south-1c.id
  route_table_id = aws_route_table.private.id
}
...
resource "aws_route_table_association" "public-af-south-1c" {
  subnet_id      = aws_subnet.public-af-south-1c.id
  route_table_id = aws_route_table.public.id
}